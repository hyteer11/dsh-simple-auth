	...
	factory: (require) => {
		...
		function ChangePasswordForm() {
			...
			if (!open) {
				return h("button", {
					type: "button",
					style: Object.assign({}, BTN_ACCENT, { width: "100%", justifyContent: "center" }),
			...
			return h("div", { style: CARD },
				...
				h("form", { onSubmit: submit },
					...
					h("div", { style: { display: "flex", gap: 8 } },
						h("button", { type: "submit", disabled: busy, style: Object.assign({}, BTN_ACCENT, { marginTop: 0 }) }, t("change.submit")),
		...
		function DisableForm() {
			...
			if (!open) {
				return h("button", {
					type: "button",
					style: Object.assign({}, BTN_DANGER_MUTED, { width: "100%", justifyContent: "center" }),
					onClick: function () { setOpen(true); },
				}, t("disable.title"));
			}
			return h("div", { style: CARD },
				...
				h("form", { onSubmit: submit },
					...
					h("div", { style: { display: "flex", gap: 8 } },
						h("button", { type: "submit", disabled: busy, style: Object.assign({}, BTN_DANGER_MUTED, { marginTop: 0 }) }, t("disable.submit")),
						h("button", { type: "button", style: Object.assign({}, BTN_OUTLINE, { marginTop: 0 }), onClick: function () { setOpen(false); } }, t("cancel"))
					),
					msg !== null && h("div", { style: msg.kind === "ok" ? MSG_OK : MSG_ERR }, msg.text)
				)
